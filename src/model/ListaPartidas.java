...
public class ListaPartidas {
    ...
    /**
	 * Metodo accesor de lectura que nos da el listado de partidas.
	 * 
	 * @return Nos devuelve el listado de partidas. 
	 */
    ...
    /**
     * Metodo accesor de escritura que asigna el listado de partidas.
     * 
     * @param listadoDelegaciones El listado de partidas.
     */
    public void setListadoPartidas(List<Partida> listaPartidas) {
        this.listaPartidas = listaPartidas;
    }
    
    /**
     * Este metodo nos permite agregar una partida al listado.
     * 
     * @param p Partida.
     */
